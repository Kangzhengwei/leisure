...
import com.kzw.leisure.service.NetworkService;
...
public class NetworkUtils {
    ...
    public static final void openGPS() {
        ...
        try {
            PendingIntent.getBroadcast(BaseApplication.getInstance(), 0, GPSIntent, 0).send();
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                switch (CURRENT_NETWORK_STATE) {
                    case -1:
                        ToastUtil.showSingleLongToast("当前没有网络");
