...
import com.kzw.leisure.utils.BitmapUtil;
import com.kzw.leisure.utils.MeUtils;
...
public class ReadBookControl {
    ...
    private ReadBookControl() {
        preferences = SPUtils.getInstance().getPrefs();
        initTextDrawable();
    ...
    private void initPageStyle() {
        ...
        if ((bgCustom == 2 || bgCustom == 3) && getBgPath(textDrawableIndex) != null) {
            ...
            if (bgCustom == 2) {
                ...
                bgBitmap = MeUtils.getFitAssetsSampleBitmap(AppUtils.getAssets(), bgPath, width, height);
            }
            if (bgBitmap != null) {
                return;
            }
