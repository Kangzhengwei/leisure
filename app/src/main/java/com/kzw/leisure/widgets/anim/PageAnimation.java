package com.kzw.leisure.widgets.anim;
...
public abstract class PageAnimation {
     ...
     */
    public enum Mode {
        COVER(AppUtils.getResource().getString(R.string.page_mode_COVER)),
        SIMULATION(AppUtils.getResource().getString(R.string.page_mode_SIMULATION)),
        SLIDE(AppUtils.getResource().getString(R.string.page_mode_SLIDE)),
        SCROLL(AppUtils.getResource().getString(R.string.page_mode_SCROLL)),
        NONE(AppUtils.getResource().getString(R.string.page_mode_NONE));
