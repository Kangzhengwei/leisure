...
import com.kzw.leisure.widgets.anim.CoverPageAnim;
import com.kzw.leisure.widgets.anim.HorizonPageAnim;
import com.kzw.leisure.widgets.anim.NonePageAnim;
...
public class PageView extends View implements PageAnimation.OnPageChangeListener {
     ...
     * 获取 PageLoader
     */
    public PageLoader getPageLoader(ReadBookActivity activity, BookRealm bookRealm, PageLoader.Callback callback) {
        ...
        // 根据书籍类型，获取具体的加载器
        mPageLoader = new PageLoaderNet(this, bookRealm, callback);
